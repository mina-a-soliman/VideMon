...
requirements = python3,kivy==2.3.0,pillow,requests,urllib3,certifi,charset-normalizer,idna,yt-dlp,brotli,mutagen,pycryptodomex,websockets,pyperclip
...
android.meta_data = com.google.android.gms.car.application=None

# (bool) Indicate whether the screen should stay on
# Don't forget to add the WAKE_LOCK permission if you set this to True
#android.wakelock = False

# (list) Android addons to use with this application
# android.add_src = 
...
# (str) python-for-android URL, defaults to upstream
...
# In newer versions, can be comma separated e.g. android.archs = arm64-v8a, armeabi-v7a
...
# 1) android.add_assets = source_dir/assets/filename
# 2) android.add_assets = source_dir/assets:dest_dir/assets
#android.add_assets =
...
# 2) A directory, here  'legal_resource_name' directory will be added to resources
# android.add_resources = legal_resource_name:path/to/directory
# 3) A directory, here  any directory in 'path/to/directory' will be added to resources
# android.add_resources = path/to/directory
...
# In case of multiple archs, use the --arch option to specify the arch to use on install
# android.archs = arm64-v8a, armeabi-v7a
...
# (str) The Android arch to build for, in case you provide several (as a comma-separated list)
# Defaults to all available architectures.
